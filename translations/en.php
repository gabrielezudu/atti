...
define("MESSAGE_MUST_CHANGE_PASSWORD", "You must change your password at first log in.");
define("MESSAGE_MUST_LOGIN_TO_SEE_THIS_PAGE", "You must be logged in to see this page.");
